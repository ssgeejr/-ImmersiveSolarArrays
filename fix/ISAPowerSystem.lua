    ...
    for key = 1, #testK do
        ...
        if (square ~= nil) then
            ...
            if (square ~= nil) then
                ...
                print("xx__LITEMODE: ", noLiteMode)
				print("xx_Drain: ", drain)
				print("xx_noLiteDrain: ", noLiteDrain)
				noLiteDrain = 0
				noLiteDrain = 0
				print("aa_Drain: ", drain)
                print("aa_noLiteDrain: ", noLiteDrain)

                if noLiteMode == 0 then
                    drain = solarscan(square, false, true, false, 0)
                end

				print("yy_Drain: ", drain)
               ...
               if noLiteMode == 1 then
				...
				print("xx_capacity: ", capacity)
				
				if actualCharge ~= nil then
					actualCharge = 900
				end
				...
				--updatedCH = (actualCharge + 0 / 6) / capacity
